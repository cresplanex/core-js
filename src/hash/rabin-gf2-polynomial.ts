 ...
 * @param {number} degree
 */
const _degreeToMinByteLength = (degree: number) =>
    math.floor(degree / 8) + 1
 ...
 */
export const createFromBytes = (bytes: Uint8Array) => {
 ...
 * @param {number} uint
 */
export const createFromUint = (uint: number) => {
 ...
 * @param {number} degree
 */
export const createRandom = (degree: number) => {
 ...
 * @return number
 */
export const getHighestDegree = (p: GF2Polynomial) => {
    return CoreArray.fold(
        CoreArray.from(p.degrees), 
        0, 
 ...
 */
export const addInto = (p1: GF2Polynomial, p2: GF2Polynomial) => {
 ...
 * @param {GF2Polynomial} p2
 */
export const orInto = (p1: GF2Polynomial, p2: GF2Polynomial) => {
    p2.degrees.forEach(degree => {
        p1.degrees.add(degree)
    })
}
 ...
 * @param {GF2Polynomial} p2
 */
export const add = (p1: GF2Polynomial, p2: GF2Polynomial) => {
 ...
 * @param {GF2Polynomial} p
 */
export const clone = (p: GF2Polynomial) => {
    const result = new GF2Polynomial()
 ...
 * @param {number} degree
 */
export const addDegreeInto = (p: GF2Polynomial, degree: number) => {
 ...
 * @param {GF2Polynomial} p2
 */
export const multiply = (p1: GF2Polynomial, p2: GF2Polynomial) => {
    const result = new GF2Polynomial()
 ...
 * @param {number} shift
 */
export const shiftLeft = (p: GF2Polynomial, shift: number) => {
    const result = new GF2Polynomial()
 ...
 * @param {GF2Polynomial} p2
 */
export const mod = (p1: GF2Polynomial, p2: GF2Polynomial) => {
 ...
 */
export const modPow = (p: GF2Polynomial, e: number, m: GF2Polynomial) => {
    let result = ONE
    while (true) {
        if ((e & 1) === 1) {
 ...
 * @param {GF2Polynomial} p2
 */
export const gcd = (p1: GF2Polynomial, p2: GF2Polynomial) => {
 ...
 * @param {GF2Polynomial} p2
 */
export const equals = (p1: GF2Polynomial, p2: GF2Polynomial) => {
 ...
 * @param {number} p
 */
const reduceExponent = (f: GF2Polynomial, p: number) => {
    // compute (x^q^p mod f)
 ...
 * @param {GF2Polynomial} p
 */
export const isIrreducibleBenOr = (p: GF2Polynomial) => {
 ...
 * @param {number} degree
 */
export const createIrreducible = (degree: number) => {
    while (true) {
 ...
 * @param {GF2Polynomial} m
 */
export const fingerprint = (buf: Uint8Array, m: GF2Polynomial) =>
    toUint8Array(mod(createFromBytes(buf), m), _degreeToMinByteLength(getHighestDegree(m) - 1))
