 ...
 */
const _precomputedFingerprintCache = new CoreMap<string, Uint8Array>()

/**
 * @param {Uint8Array} m
 */
const ensureCache = (m: Uint8Array) => 
    _precomputedFingerprintCache.setIfUndefined(buffer.toBase64(m), () => {
 ...
 */
export const fingerprint = (irreducible: Uint8Array, data: Uint8Array) => {
